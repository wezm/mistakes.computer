...
(def expected-body @`<article><main><h1>Foo was a mistake</h1></main><footer><p>One of 99 mistakes, <a href="/foo">share this mistake</a> or <a href="/">view another one</a>. </p>A fun project by <a href="https://www.wezm.net/">wezm</a> to try out <del>Deno Deploy</del> <a href="https://janet-lang.org/">Janet</a>. <a href="https://github.com/wezm/mistakes.computer">Source on GitHub</a>, contributions welcome.</footer></article>`)
